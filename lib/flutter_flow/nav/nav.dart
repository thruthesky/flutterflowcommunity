...
class AppStateNotifier extends ChangeNotifier {
  FlutterFlowDevCommunityFirebaseUser initialUser;
  FlutterFlowDevCommunityFirebaseUser user;
  ...
  void update(FlutterFlowDevCommunityFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) =>
          appStateNotifier.loggedIn ? HomeScreenWidget() : SignInScreenWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'inviteFriendsScreen',
              requireAuth: true,
              builder: (context, params) => InviteFriendsScreenWidget(),
            ),
            FFRoute(
              name: 'postListScreen',
              path: 'postListScreen',
            ...
            FFRoute(
              ...
              path: 'postViewScreen',
              requireAuth: true,
              builder: (context, params) => PostViewScreenWidget(
